...
<div className='text-center'>
    ...
    <p className='mt-1 text-xs text-zinc-400'>This may take 10-20  seconds 
           </p>
</div>
...
{/* Image preview  */}
   {
    !isLoading&& thumbnail?.image_url && <div className='group relative h-full w-full'>
...
<div className='px-4 text-center'>
    <p className='font text-zinc-200'>Generate Your Thumbnel</p>
